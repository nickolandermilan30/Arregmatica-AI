...
const Quiz = () => {
  ...
  return (
    <div className="min-h-screen flex items-center justify-center bg-gray-100 dark:bg-gray-900 transition-colors duration-300 p-6">
      <div className="bg-white dark:bg-gray-800 rounded-xl shadow-lg flex flex-col lg:flex-row max-w-6xl w-full overflow-hidden transition-colors duration-300">
        {/* Quiz Info Box */}
        ...
        {/* User Info Form */}
        <div className="w-full lg:w-1/2 bg-gray-50 dark:bg-gray-700 p-8 order-2 lg:order-2 transition-colors duration-300">
          ...
          <form className="space-y-4" onSubmit={handleStartQuiz}>
            ...
            <div>
              ...
              <div className="relative">
                <input
                  ...
                  readOnly
                  className="w-full border border-gray-300 dark:border-gray-600 rounded-lg p-2 pr-10 bg-gray-100 dark:bg-gray-600 text-gray-700 dark:text-gray-200 cursor-not-allowed"
                />
                <Lock className="absolute right-3 top-2.5 text-gray-500 dark:text-gray-400 w-5 h-5" />
              </div>
            </div>
            ...
            <div>
              ...
              <select
                ...
                className="w-full border border-gray-300 dark:border-gray-600 rounded-lg p-2 focus:outline-none focus:ring-2 focus:ring-sky-500 bg-white dark:bg-gray-600 text-gray-700 dark:text-gray-200"
                required
              >
            ...
            <div className="flex items-center mt-4">
              <input
                ...
                className="mr-2 w-4 h-4 text-sky-500 border-gray-300 dark:border-gray-600 rounded"
              />
              <label htmlFor="agreement" className="text-gray-700 dark:text-gray-300">
