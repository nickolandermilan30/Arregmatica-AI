    ...
    <div className="min-h-screen flex items-center justify-center bg-gray-100 p-6">
      <div className="bg-white rounded-xl shadow-lg flex flex-col lg:flex-row max-w-6xl w-full overflow-hidden">
        ...
        <div className="w-full lg:w-1/2 p-8 order-1 lg:order-1">
          <h1 className="text-3xl font-bold text-gray-800 mb-4">Ready for the Quiz?</h1>
          <p className="text-gray-600 mb-4">
            🕒 <span className="font-semibold">Timer:</span> Each question has a time limit (displayed during the quiz).
          </p>
          <p className="text-gray-700 mb-6">
            This quiz is designed to test your knowledge across four different classes. Each class contains four multiple-choice questions. 
            The goal is to challenge your understanding and reinforce key concepts you've learned so far. Make sure to read each question carefully 
            before answering. Remember, this quiz is timed, so manage your time wisely. Good luck!
          </p>
        ...
        <div className="w-full lg:w-1/2 bg-gray-50 p-8 order-2 lg:order-2">
          ...
          <form className="space-y-4" onSubmit={handleStartQuiz}>
            ...
            <div>
              <label className="block text-gray-700 mb-1">Occupation / Student</label>
              <select
                name="occupation"
